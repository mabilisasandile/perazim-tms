...
router.get('/profile/:driverId', requirePermission('driverList'), wrap(async (req, res) => {
...
router.get('/expiring-soon', requirePermission('driverList'), wrap(async (req, res) => {
...
router.post('/drivers/:driverId/documents', requirePermission('driverEdit'), upload.single('file'), wrap(async (req, res) => {
...
router.patch('/documents/:id', requirePermission('driverEdit'), wrap(async (req, res) => {
  const doc = await driverDocsService.updateDocument(Number(req.params.id), req.body);
  res.json(doc);
}));

router.delete('/documents/:id', requirePermission('driverEdit'), wrap(async (req, res) => {
...
router.post('/drivers/:driverId/contacts', requirePermission('driverEdit'), wrap(async (req, res) => {
  const c = await driverDocsService.addContact(Number(req.params.driverId), req.body);
  res.status(201).json(c);
}));

router.patch('/contacts/:id', requirePermission('driverEdit'), wrap(async (req, res) => {
  const c = await driverDocsService.updateContact(Number(req.params.id), req.body);
  res.json(c);
}));

router.delete('/contacts/:id', requirePermission('driverEdit'), wrap(async (req, res) => {
...
router.post('/drivers/:driverId/incidents', requirePermission('driverEdit'), wrap(async (req, res) => {
  const inc = await driverDocsService.addIncident(Number(req.params.driverId), req.body);
  res.status(201).json(inc);
}));

router.patch('/incidents/:id', requirePermission('driverEdit'), wrap(async (req, res) => {
  const inc = await driverDocsService.updateIncident(Number(req.params.id), req.body);
  res.json(inc);
}));

router.delete('/incidents/:id', requirePermission('driverEdit'), wrap(async (req, res) => {
...
router.post('/drivers/:driverId/warnings', requirePermission('driverEdit'), wrap(async (req, res) => {
  const w = await driverDocsService.addWarning(Number(req.params.driverId), req.body);
  res.status(201).json(w);
}));

router.patch('/warnings/:id', requirePermission('driverEdit'), wrap(async (req, res) => {
  const w = await driverDocsService.updateWarning(Number(req.params.id), req.body);
  res.json(w);
}));

router.delete('/warnings/:id', requirePermission('driverEdit'), wrap(async (req, res) => {
